...
const uploadGeneratedName = cloudinary.uploader.upload('src/assets/img/search.png', { tags: 'basic_sample' }, (err, image) => {
    console.log()
...
const uploadCustomName = cloudinary.uploader.upload('src/assets/img/search.png', { tags: 'basic_sample', public_id: 'search_icon' }, function (err, image) {
    console.log();
